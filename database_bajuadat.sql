...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2025 at 04:13 PM
...
--
ALTER TABLE `detail_pesanan_222145`
  MODIFY `detail_id_222145` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pelanggan_222145`
--
ALTER TABLE `pelanggan_222145`
  MODIFY `pelanggan_id_222145` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `pembayaran_222145`
--
ALTER TABLE `pembayaran_222145`
  MODIFY `pembayaran_id_222145` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pesanan_222145`
--
ALTER TABLE `pesanan_222145`
  MODIFY `pesanan_id_222145` int(11) NOT NULL AUTO_INCREMENT;
